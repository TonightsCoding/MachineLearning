...
\lstinputlisting[language=MATLAB, caption=Auszug Matlab-Funktion GetGaussWeights \ref{GetGaussWeights}, numbers=left, firstline=74, lastline=78, firstnumber=74]{../Tool/GetGaussWeights.m} \label{code:Add75}
...
\lstinputlisting[language=MATLAB, caption=Auszug Matlab-Funktion GetGaussWeights \ref{GetGaussWeights}, label=code:Mul175, numbers=left, firstline=62, lastline=66, firstnumber=62]{../Tool/GetGaussWeights.m}
