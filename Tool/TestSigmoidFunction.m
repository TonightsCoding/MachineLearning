...
x1Default = x1;
x2Default = x2;
% defualt-Werte fuer x1 und x2 aus SigmoidFunction zur Veranschaulichung
% x1Default = -12;
% x2Default = 12;
...
% nice22 = 15;
% x22 = 0;
[sigmoid, y] = SigmoidFunction(nice22, x22);
disp(sigmoid);
disp(y);
...
% x131 = -12;
% x231 = 12;
sigmoid = SigmoidFunction(nice31, x131, x231);
disp(sigmoid);
...
% x32 = 0;
% bias = 0;
[sigmoid, y] = SigmoidFunction(nice32, x32, bias32);
disp(sigmoid);
disp(y);
...
% x41 = 0;
% bias41 = 0;
y = SigmoidFunction(y141, y241, x41, bias41);
disp(y);
% 2-Outputs
...
% x242 = 15;
% x42 = 0;
[sigmoid, y] = SigmoidFunction(nice42, x142, x242, x42);
disp(sigmoid);
disp(y);
...
% y151 = -1;
% y251 = 1;
sigmoid = SigmoidFunction(nice51, x151, x251, y151, y251);
disp(sigmoid);
...
% x52 = 0;
% bias52 = 0;
[sigmoid, y] = SigmoidFunction(nice52, x152, x252, x52, bias52);
disp(sigmoid);
disp(y);
...
% y261 = 1;
% bias61 = 5;
sigmoid = SigmoidFunction(nice61, x161, x261, y161, y261, bias61);
disp(sigmoid);
...
% y262 = 1;
% x62 = 0;
[sigmoid, y] = SigmoidFunction(nice62, x162, x262, y162, y262, x62);
disp(sigmoid);
disp(y);
...
% x71 = 0;
% bias71 = 0;
y = SigmoidFunction(nice71, x171, x271, y171, y271, x71, bias71);
disp(y);
% 2 Outputs
...
% x72 = 0;
% bias72 = 0;
[sigmoid, y] = SigmoidFunction(nice72, x172, x272, y172, y272, x72, bias72);
disp(sigmoid);
disp(y);
