...
hold on
plot(t41, lin41);
title('4 Inputs "nice, a, x1, x2" -> 1 Outputs "lin"');
% 2 Outputs
...
%% 5 Inputs
% 1 Output
% y = LinearFunction(a, y1, y2, x, bias)
a51 = a;
y151 = y1;
y251 = y2;
x51 = x;
...
% x51 = x;
% bias51 = bias;
y51 = LinearFunction(a51, y151, y251, x51, bias51);
disp(y51); 
% 2 Outputs
...
hold on
plot(t61, lin61);
title('6 Inputs "nice, a, x1, x2, y1 & y2" -> 1 Outputs "lin"');
% 2 Outputs
...
hold on
plot(t71, lin71);
title('7 Inputs "nice, a, x1, x2, y1, y2 & bias" -> 1 Outputs "lin"');
% 2 Outputs
...
hold on
plot(t81, lin81);
title('8 Inputs "everything except x & bias" -> 1 Outputs "lin"');
% 2 Outputs
...
hold on
plot(t91, lin91);
title('9 Inputs "everything except x" -> 1 Outputs "lin"');
% 2 Outputs
